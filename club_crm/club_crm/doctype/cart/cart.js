...
frappe.ui.form.on("Cart", "onload", function(frm) {
    ...
    frm.fields_dict.cart_session.grid.get_field("package_name").get_query = function(doc, cdt, cdn) {
        if (locals[cdt][cdn].package_type == "Spa") {
            return {
                filters: [
                    ["Club Packages", "package_type", "in", "Spa"]
                ]
            }
        }
        if (locals[cdt][cdn].package_type == "Fitness") {
            return {
                filters: [
                    ["Club Packages", "package_type", "in", "Fitness"]
                ]
            }
        }
        if (locals[cdt][cdn].package_type == "Club") {
            return {
                filters: [
                    ["Club Packages", "package_type", "in", "Club"]
                ]
            }
        }
    }
...
>>>>>>> 7c0ae1cbc0f331aeacabc7dd76d22d6a4329518b
        ...
        if (frm.doc.balance_amount == 0.0 && frm.doc.docstatus == 0) {
            frm.add_custom_button(__('Submit'), function() {
                frappe.call({
                    method: 'club_crm.club_crm.doctype.cart.cart.submit_cart',
